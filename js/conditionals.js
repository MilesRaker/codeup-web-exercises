...
/*function analyzeColor(input){
    if(input === 'red'){
        ...
        return "Yellow gets me thinking about birds.";
    }else if(input === "green"){
        return "green, like grasssssss"
    }else{
...
console.log(analyzeColor("blue-ish"));
/**
 * TODO:
...
alert("analyze color returned: " + analyzeColor(userColor));
/* ########################################################################## */
...
function calculateTotal(luckyNumber, totalPrice){
    switch(luckyNumber){
        ...
        case 5:
            return 0;
        default:
            return totalPrice; // includes luckyNumber = 0, and all unsupported numbers
    }
}
...
let total = parseFloat(prompt("How much did is the total bill?"));
alert("Your lucky number is: " + luckyNumber + " and your discounted total is: " + calculateTotal(luckyNumber, total));
